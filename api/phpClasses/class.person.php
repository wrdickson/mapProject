...
class Person {
    ...
    public function set_username($username) {
        $tt_user_id = $this->get_person_id();
        $this->username = $username;
        $result = mysql_query("UPDATE users SET user_name = '$username' WHERE id = $id");
    ...
    public function set_email($newEmail) {
        $xid = $this->get_id();
        $pdo = DataConnecter::getConnection();
        $stmt = $pdo->prepare("UPDATE users SET user_email = :newEmail WHERE id = :xid");
